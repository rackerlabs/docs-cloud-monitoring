...
The Rackspace Cloud Monitoring API is implemented by using a RESTful web service
...
.. note::
   All requests to authenticate and operate against the Rackspace Cloud Monitoring API
