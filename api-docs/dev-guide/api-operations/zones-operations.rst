...
machine or a virtual machine. A monitoring zone contains many
endpoints, all of which will be within the IP address range listed
in the response. The opposite is not true, however, as there may
be unallocated IP addresses or unrelated machines within that IP address range.
...
Use the monitoring zones API operations to get information about
monitoring zones and to run traceroutes.

.. note:: Users cannot create, update, or delete monitoring zones.

.. include:: methods/get-list-monitoring-zones-monitoring-zones.rst
.. include:: methods/get-get-monitoring-zone-by-id-monitoring-zones-monitoringzoneid.rst
.. include:: methods/post-perform-a-traceroute-from-a-monitoring-zone-monitoring-zones-monitoringzoneid-traceroute.rst
